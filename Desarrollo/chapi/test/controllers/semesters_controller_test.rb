...
class SemestersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create semester" do
    assert_difference('Semester.count') do
      post semesters_url, params: { semester: { datetime_end: @semester.datetime_end, datetime_start: @semester.datetime_start, name: @semester.name } }, as: :json
    end
  ...
  test "should update semester" do
    patch semester_url(@semester), params: { semester: { datetime_end: @semester.datetime_end, datetime_start: @semester.datetime_start, name: @semester.name } }, as: :json
    assert_response 200
  end
